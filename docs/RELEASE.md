...
3. **Shared packaging hardening** — keep application behavior shared between formats, harden resource/config paths and metadata, pin external build tooling, define the AppImage compatibility baseline, and keep provenance-sensitive inherited content out of both artifacts.
...
This is a UI-polish requirement, not a packaging-proof blocker.
