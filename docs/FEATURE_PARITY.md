...
No further routine gameplay or packaging QA is required before a release/publication decision. Additional QA should be bounded to a specific newly identified risk. No main integration, release, public binary, Nexus publication, upstream submission, GitHub Actions use, or other external publication has been authorized.
