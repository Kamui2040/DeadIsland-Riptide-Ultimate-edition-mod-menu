...
CHECKBOX_OPTIONS = (
    ...
    CheckboxOption(
        ...
        "Gameplay",
        "Combat",
        "98% chance for bullets to pass through zombies, allowing collateral hits.",
    ),
    CheckboxOption(
        "instant_break_doors",
        ...
        "Gameplay",
        "Combat",
        "Makes the break-door minigame almost an instant break every time.",
    ),
    CheckboxOption(
        "increase_durability",
        "Increase durability",
        "Gameplay",
        "Gear & loot",
        "Reduces weapon durability loss from 1.0 to 0.5, so weapons last longer between repairs.",
    ),
    CheckboxOption(
        "hold_more_ammo",
        "Hold more ammo",
        "Gameplay",
        "Gear & loot",
        "Raises max ammo: pistol 200, rifle 150, shotgun 90.",
    ),
    CheckboxOption(
        "deeper_pockets",
        "Even deeper pockets",
        "Gameplay",
        "Gear & loot",
        "Buffs Deeper Pockets up to 30 slots. Existing saves: enable before unlocking the skill.",
    ),
    CheckboxOption(
        "improved_loot",
        "Improved loot",
        "Gameplay",
        "Gear & loot",
        "Reduces white weapons from locked chests and improves loot odds from Butchers and Rams.",
    ),
    CheckboxOption(
        "reduce_sunflare",
        "Reduce sunflare 90%",
    ...
    CheckboxOption(
        ...
        "Firearms",
        "Firearms",
        "Each firearm upgrade improves fire rate, recoil and auto-reload speed; manual reload stays default.",
    ),
)
...
CHOICE_GROUPS = (
    ...
    ChoiceGroup(
        ...
        "Firearms POV",
        "Firearms",
        "Fixes sight blur and iron-sight alignment, and improves firearm aim and hip-fire positioning.",
        (
